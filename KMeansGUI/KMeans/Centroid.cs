...
namespace KMeansProject
{
    public class Centroid
    {
        ...
        public void DrawMe(PaintEventArgs e)                      /* Sınıflandırma işlemi başlayınca ekrana dikdörtgenler çizdirir.
                                                                           Bunların kalınlık ve  boyutlarını belirler */
        {                                                      
            ...
            {
                g.DrawRectangle(new Pen(_color, 1.0f), (float)point[0], (float)point[1], 10, 10);
            }
        }
        ...
        public void MoveCentroid()                /* Veriler en yakın sınıf merkezine atanır daha sonra merkezleri yeniden hesaplamır.
        ...
        public bool HasChanged()                  /* Algoritma adımları yeteri kadar tekrarlanır ise tüm veriler sınıflanır.*/
        {
            bool result = true;
