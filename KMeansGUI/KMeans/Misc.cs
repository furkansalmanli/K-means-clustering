...
namespace KMeansProject
{
    public static class Misc
    {
        ...
        static Misc()
        {
            ...
            centroidColors[0] = Color.DarkTurquoise;                           // Şekillerimizin renk seçimini yaptık.
            centroidColors[1] = Color.Red;
        }
                                                                                  // Şekillerimizi atamak geçici diziler kullanarak. Yenileri ile yer değiştirdik.
        public static List<double[]> Clone(List<double[]> array)
        {
            ...
            return resultList;
                                                      ...
                                                      // Girilen datasete göre  verilerimizin ne kadar artış gösterecğini hesapladık.
